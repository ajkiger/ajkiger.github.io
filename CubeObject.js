...
function CubeObjectAwake() {
    ...
    /*
    var blueSquare = new Object();
    blueSquare.minU = 0.75;
    blueSquare.maxU = 0.875;
    blueSquare.minV = 0.25;
    blueSquare.maxV = 0.375;
    
    var redSquare = new Object();
    redSquare.minU = 0.75;
    redSquare.maxU = 0.875;
    redSquare.minV = 0.125;
    redSquare.maxV = 0.25;
    
    var blankSquare = new Object();
    blankSquare.minU = 0.875;
    blankSquare.maxU = 1.0;
    blankSquare.minV = 0.0;
    blankSquare.maxV = 0.125;
    */
    /*
    for(var i = 0; i < 26; i++){
        alphabetLetters[i] = new Object();
    }
