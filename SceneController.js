...
function LoadScores(){
    ...
    if(typeof(Storage)!=="undefined")
    {
        ...
        soundTrack.playNow = localStorage.getItem("tMusic");
        if(soundTrack.playNow === "false"){
...
function SaveScores(){
    ...
    if(typeof(Storage)!=="undefined")
    {
        ...
        var lStore3 = soundTrack.playNow;
        var lKey3 = "tMusic";
